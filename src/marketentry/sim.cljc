...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (SLB, clean) ==")
    ...
    (println "== jurisdiction/assess eng-4 (sets up certificate-scope-exceeded) ==")
    ...
    (println "== filing/submit eng-4 (certificate-scope-exceeded -> HARD hold) ==")
