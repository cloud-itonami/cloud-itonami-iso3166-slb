(ns marketentry.store
  "SSoT for the Solomon Islands (SLB) market-entry compliance actor,
...
(defn demo-data
  ...
  `:claims-certificate-covers-activity?` / `:declared-activity` /
  `:certificate-registered-activities` are ground truth for the
  `certificate-scope-exceeded` flagship check (Foreign Investment Act
  2005, ss.12(3)-(4)/13(a)/21(2)(b) certificate-of-registration
  activity-scope regime); `:requires-tin-record?` / `:tin-record-
  verified?` are ground truth for the conditional IRD TIN-record
  check."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Honiara Fabrication Ltd" :portal "solomonbusinessregistry.gov.sb"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :claims-certificate-covers-activity? false
             :declared-activity nil :certificate-registered-activities nil
             :requires-tin-record? true :tin-record-verified? true
             :drafted? false :submitted? false
             :jurisdiction "SLB" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "solomonbusinessregistry.gov.sb"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :claims-certificate-covers-activity? false
             :declared-activity nil :certificate-registered-activities nil
    ...
    "eng-3" {:id "eng-3" :operator "Auki Trading Co" :portal "solomonbusinessregistry.gov.sb"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "SLB" :status :intake}
    "eng-4" {:id "eng-4" :operator "Munda Logistics Ltd" :portal "solomonbusinessregistry.gov.sb"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "SLB" :status :intake}
    "eng-5" {:id "eng-5" :operator "Gizo Supplies Cooperative" :portal "solomonbusinessregistry.gov.sb"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :claims-certificate-covers-activity? false
             :declared-activity nil :certificate-registered-activities nil
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               claims-certificate-covers-activity? declared-activity
                               certificate-registered-activities
  ...
  (cond-> {:engagement/id id}
    ...
    (some? claims-certificate-covers-activity?) (assoc :engagement/claims-certificate-covers-activity? claims-certificate-covers-activity?)
    (some? declared-activity)             (assoc :engagement/declared-activity declared-activity)
    (some? certificate-registered-activities) (assoc :engagement/certificate-registered-activities (ls/enc certificate-registered-activities))
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/claims-certificate-covers-activity? :engagement/declared-activity
   :engagement/certificate-registered-activities
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :claims-certificate-covers-activity? (boolean (:engagement/claims-certificate-covers-activity? m))
     :declared-activity (:engagement/declared-activity m)
     :certificate-registered-activities (when-let [v (:engagement/certificate-registered-activities m)] (ls/dec* v))
